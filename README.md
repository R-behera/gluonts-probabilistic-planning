...
# GluonTS Probabilistic Planning

![Demo Screenshot](demo/screenshot.png)

## Overview
Turn probabilistic forecasting into a planning UI with uncertainty-aware allocations, error bands, and scenario notes for operators.
...
## Project Profile
- Domain: Probabilistic Forecasting
- Project type: `ml`
- Tags: gluonts, forecasting, probabilistic, planning
